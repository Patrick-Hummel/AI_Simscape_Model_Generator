...
class AbstractComponent(ABC):
    ...
    def __init__(self, comp_id: int, unique_name: str, input_ports_list: List[str], output_ports_list: List[str]):
        self._comp_id = comp_id
        self._unique_name = unique_name
        self._input_ports_list = input_ports_list
        self._output_ports_list = output_ports_list
    ...
    @property
    def input_ports_list(self) -> List[str]:
        return self._input_ports_list

    @property
    def output_ports_list(self) -> List[str]:
        return self._output_ports_list
